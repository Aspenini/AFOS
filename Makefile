...
web: iso
	...
	@echo ""
	@echo "The ISO file (web/afos.iso) is now ready to be committed to git."
	@echo "To commit it:"
	@echo "  git add web/afos.iso"
	@echo "  git commit -m 'Update web ISO'"
	@echo ""
	@echo "To run locally:"
	...
	@echo ""
	@echo "GitHub Actions will automatically build and deploy to afos.aspenini.com"
