#!/usr/bin/env python3
"""
Build script to embed files/sys/ directory into the kernel filesystem.
Generates sysfs_data.c which contains all files from files/sys/ directory.
"""
...
def collect_files(base_dir):
    """Collect all files from files/sys/ directory, preserving structure."""
    files = []
...
def generate_c_file(files, output_file):
    ...
    with open(output_file, 'w') as f:
        f.write("/* Auto-generated file system data from files/sys/ directory */\n")
        ...
        f.write("/* Initialize filesystem with files from files/sys/ directory */\n")
...
def main():
    ...
    if not os.path.exists(base_dir):
        ...
        with open(output_file, 'w') as f:
            f.write("/* Auto-generated file system data from files/sys/ directory */\n")
            f.write("/* files/sys/ directory not found */\n\n")
            f.write("#include \"filesystem.h\"\n")
            f.write("#include \"types.h\"\n\n")
            f.write("void sysfs_initialize(void) {\n")
    ...
    if not files:
        ...
        with open(output_file, 'w') as f:
            f.write("/* Auto-generated file system data from files/sys/ directory */\n")
            f.write("/* No files found in files/sys/ */\n\n")
            f.write("#include \"filesystem.h\"\n")
            f.write("#include \"types.h\"\n\n")
            f.write("void sysfs_initialize(void) {\n")
            f.write("    /* No files to load */\n")
